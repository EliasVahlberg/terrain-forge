...
fn main() {
    ...
    println!("   Generated {}x{} dungeon with ~{} rooms", 
             grid.width(), grid.height(), room_count);
    ...
    println!("     Expected for {} rooms: {}", room_centers.len(), room_centers.len().saturating_sub(1));
    ...
    println!("     Avg clustering: {:.3}", full_analysis.average_clustering);
